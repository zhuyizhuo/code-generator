...
public class ${tableInfo.tableName}ServiceImpl implements ${tableInfo.tableName}Service {
	 ...
	 * @see ${serviceFullPackage}.${tableInfo.tableName}Service#batchInsert${tableInfo.tableName}(${javaBeanFullPackage}.${tableInfo.tableName})
	 */
	@Override
	public void batchInsert${tableInfo.tableName}(List<${tableInfo.tableName}> ${tableInfo.tableName?uncap_first}List) {
		${tableInfo.tableName?uncap_first}DaoImpl.batchInsert${tableInfo.tableName}(${tableInfo.tableName?uncap_first}List);
	};
